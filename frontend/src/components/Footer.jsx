            ...
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-10">
                <div className="md:max-w-96">
                    ...
                    <p className="mt-6 text-sm">
                        A modern movie streaming website where users can discover the latest movies, watch trailers, explore detailed movie information, and enjoy a smooth browsing experience. The platform features a clean, responsive interface with attractive movie posters, categorized content, interactive trailers, and an intuitive design optimized for desktop, tablet, and mobile devices.
                    </p>
