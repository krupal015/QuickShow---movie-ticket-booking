...
const getMyBookings = async () => {
  ...
  return !isLoading ? (
    <div>
        <div className='relative px-6 md:pc-16 lg:px-40 pt-30 md:pt-40 min--h-[80vh]'>
              ...
              <div className='flex flex-col md:flex-row justify-between bg-primary/8 border border-primary/20 rounded-lg mt-4 p-2 max-w-3xl'>
                  ...
                  <div className='flex flex-col md:items-end md:text-right justify-between p-4'>
                    <div className='flex items-center gap-4'>
                      ...
                      {!item.isPaid && <button className='bg-primary px-4 py-1.5 text-sm font-medium cursor-pointer rounded-full'>Pay Now</button>}
                      </div>
